...
- The assembly language program stores the intermediate results in the saved registers.
- The temporary registers can also be used to save the intermediate results.
